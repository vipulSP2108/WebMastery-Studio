...
export default function Nav() {
    ...
    return (
        <motion.div
            className="fixed z-[999] bg-opacity-0 w-full h-16 py-2 flex-1 shadow-lg backdrop-blur-lg border border-opacity-20 border-white"
            initial={{ y: "0" }}
            animate={Visibility ? { y: "0" } : { y: "0" }}
            transition={{ ease: Power4.easeInOut, delay: 0 }}
        >

            {/* <div className='fixed z-[999] w-full bg-zinc-900 h-16 py-2 flex-1'> */}
            <div className='font-["Neue_Montreal"] py-2 flex justify-around'>
                ...
                <div className='w-1/2 flex justify-between capitalize text-base'>
                    <div className='flex gap-5 items-end'>
                        <AnchorLink href="#About"><button>Services</button></AnchorLink>
                        <AnchorLink href="#Projects"><button>Our work</button></AnchorLink>
                        <AnchorLink href="#Laster"><button>About us</button></AnchorLink>
                        <AnchorLink href="#Footer"><button>Insights</button></AnchorLink>
                    </div>
                    <div className='flex items-end'>
                    <AnchorLink href="#Footer"><button>Contact us</button></AnchorLink>
                    </div>
                </div>
            </div>
        </motion.div>
